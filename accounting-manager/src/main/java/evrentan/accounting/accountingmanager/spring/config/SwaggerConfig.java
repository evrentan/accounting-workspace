...
public class SwaggerConfig {
   ...
   */
  private static final String CONTROLLER_PATH = "evrentan.accounting.accountingmanager.controller";
  ...
  public OpenAPI swaggerDocumentation() {
    ...
    return new OpenAPI()
        .info(new Info().title("Swagger UI")
            .description("Accounting Manager Swagger UI")
            .version("1.0.0")
            .contact(contact)
  ...
  /**
   * Bean declaration for Swagger documentation details for all APIs within the {@link SwaggerConfig#CONTROLLER_PATH} field and matching "/accounting/**" end-points.
   *
   * @return GroupedOpenAPI. Please, see the {@link GroupedOpenApi} class for details.
   *
   * @author <a href="https://github.com/evrentan">Evren Tan</a>
